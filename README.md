...
* [Fonts](/amnykon/dotfiles/tree/master/conf/osx/fonts) via the [init/50_osx_fonts.sh](init/50_osx_fonts.sh) script
...
If you modify things and notice a bug or an improvement, [file an issue](https://github.com/amnykon/dotfiles/issues) or [a pull request](https://github.com/amnykon/dotfiles/pulls) and let me know.
...
You might want to set up your ubuntu server [like I do it](https://github.com/amnykon/dotfiles/wiki/ubuntu-setup), but then again, you might not.
...
1. Fork this repo
1. Open a terminal/shell and do this (change `amnykon` and `master` as appropriate):

#### Ubuntu

```sh
export DOTFILES_GH_USER=amnykon
...
```sh
bash -c "$(wget -qO- https://raw.github.com/amnykon/dotfiles/master/bin/dotfiles)" && source ~/.bashrc
```

#### macOS

```sh
bash -c "$(curl -fsSL https://raw.github.com/amnykon/dotfiles/master/bin/dotfiles)" && source ~/.bashrc
```
